    ...
    <div class="container pt-5 pb-md-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mt-md-0 mt-4">
                <img class="img-fluid" src="/images/bannerimg.png" alt=" ">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="container py-lg-4 py-md-3">
            <div class="row">
                <div class="col-lg-6 content-photo">
                    <a href="#image"><img src="/images/about.png" class="img-responsive"
                                          alt="content-photo"></a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="position-relative">
                                <img src="/images/team1.jpg" class="img-responsive" alt="content-photo">
                        ...
                        <div class="col-sm-6 mt-sm-0 mt-4">
                            <div class="position-relative">
                                <img src="/images/team2.jpg" class="img-responsive" alt="content-photo">
                                <div class="text-position">
        ...
        <div class="container py-md-4 py-3">
            <div class="row">
                ...
                <div class="col-lg-7 left-wthree-img text-righ mt-lg-0 mt-5">
                    <div class="position-relative">
                        <img src="/images/video.jpg" alt="" class="img-fluid radius-image-full">
                        <a href="#small-dialog"
